package com.example.logintest.fragments;
 ...
 * Use the {@link ChangePasswordActivity#newInstance} factory method to
...
public class ChangePasswordActivity extends Fragment {
     ...
     * @return A new instance of fragment ChangePasswordActivity.
     */
    // TODO: Rename and change types and number of parameters
    public static ChangePasswordActivity newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button closeButton = view.findViewById(R.id.cancel_button);
        Button changeButton = view.findViewById(R.id.buttonRegister);
        ...
        closeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                requireActivity().getSupportFragmentManager().beginTransaction().remove(ChangePasswordActivity.this).commit();
            }
        });
